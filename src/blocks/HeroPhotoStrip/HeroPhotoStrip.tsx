...
import styles from './HeroPhotoStrip.module.css'

/**
 * HeroPhotoStrip — About Us hero with a staggered 4-photo strip.
 *
 * Saved to src/blocks/ — available for reuse on any page that needs a
 * centred headline + a horizontal row of vertically-staggered photo cards
 * that overlap the section below via margin-bottom: -100px.
 *
 * To use: copy this file and HeroPhotoStrip.module.css into src/components/,
 * adjust HERO_PHOTOS and text content, ensure the parent section/wrapper
 * does NOT clip overflow so the photo overlap is visible.
 */
